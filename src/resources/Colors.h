...
inline const Color LightGreyAlpha = {192, 203, 220, 190};       // 0.85 * 255
inline const Color LightGreyTransparent = {150, 150, 150, 77};  // 0.30 * 255
inline const Color LightGreyLessTransp = {150, 150, 150, 158};  // 0.50 * 255
...
inline const Color notificationOrange = {247, 118, 34, 255};
}  // namespace Colors
