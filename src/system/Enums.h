...
inline std::unordered_map<Stat, std::string> statToName = {
    ...
    {ARCANE_COST_REDUCTION_P, "Arcane Cost Reduction (%)"},
    {DARK_COST_REDUCTION_P, "Dark Cost Reduction (%)"},
    {POISON_COST_REDUCTION_P, "Poison Cost Reduction (%)"},
    {FIRE_COST_REDUCTION_P, "Fire Cost Reduction (%)"},
    {ICE_COST_REDUCTION_P, "Ice Cost Reduction (%)"},
