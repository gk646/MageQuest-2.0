#ifndef MAGEQUEST_SRC_UI_PLAYER_ELEMENTS_CHARACTERITEMS_H_
#define MAGEQUEST_SRC_UI_PLAYER_ELEMENTS_CHARACTERITEMS_H_
 ...
 private:
  static void DrawBigPlayer(const RectangleR& scaledRect) noexcept {
    ...
    if (!PLAYER.moving && action_state == 0) {
      DrawTextureScaled(resource->idle[(int)PLAYER.playerSpriteCount % 80 / 10],
...
#endif  //MAGEQUEST_SRC_UI_PLAYER_ELEMENTS_CHARACTERITEMS_H_
