...
static void Load() noexcept {
  ...
  //Quests::THE_GROVES_SECRET =      ScriptParser::Load("Quests/TheGrovesSecret.txt", Quest_ID::THE_GROVES_SECRET, true);
  //Quests::NIETZSCHE =      ScriptParser::Load("Quests/Nietzsche.txt", Quest_ID::NIETZSCHE_QUEST, true);
